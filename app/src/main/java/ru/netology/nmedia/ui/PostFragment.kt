...
class PostFragment: Fragment() {
    ...
    ): View? = PostFragmentBinding.inflate(layoutInflater, container, false).also { binding->
            ...
            with(binding.postLayout) {
                if (currentPost != null) {
                    ...
                    val fragment = PostFragment()
                        ...
                        postDate.text = android.text.format.DateFormat.format("yyyy-MM-dd hh:mm", currentPost.date)
