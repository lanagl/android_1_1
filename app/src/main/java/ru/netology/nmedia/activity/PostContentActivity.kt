...
class PostContentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val editText= extras?.getString("editContent")
    ...
    class ResultContractForEdit : ActivityResultContract<String, String?>(){
        override fun createIntent(context: Context, input: String) =
            Intent(context, PostContentActivity::class.java).putExtra("editContent", input)
    ...
    private companion object{
        private const val RESULT_KEY = "postForSaveContent"
    }
